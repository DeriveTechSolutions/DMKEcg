...
void SendUCA0Data(unsigned char val);    // function to send the value over SPI : UCA0TXBUF
...
uint8_t SPI_transfer(uint8_t data);      // function to store the data from SPI : MISO to the variable
